...
<?php 
    ...
    if($_FILES['imagen']['name'] !=""){
        $insertar ="UPDATE productos SET id= $identificador, nombre='$nombre', descripcion='$descripcion', precio=$precio, fotografia='$nombreArchivo' WHERE id = $idm";

    }
    else{
        $insertar ="UPDATE productos SET id= $identificador, nombre='$nombre', descripcion='$descripcion', precio=$precio, fotografia='$nombreantiguo' WHERE id = $idm";
